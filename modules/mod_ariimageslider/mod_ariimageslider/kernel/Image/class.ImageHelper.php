...
class AriImageHelper extends AriObject
{
	...
	public static function generateThumbnail($originalImgPath, $thumbDir, $prefix, $thumbWidth = 0, $thumbHeight = 0, $type = 'resize', $typeParams = array(), $filters = array())
	{
		...
		$thumbName = self::generateThumbnailFileName($prefix, $originalImgPath, $width, $height, $type);
	...
	public static function initAsido()
	{
		static $initialized;
