...
{
	public static function init($preferDrivers = array('gd', 'imagick2', 'imagick', 'magickwand'))
	{
		...
		{
			if (self::isExtensionLoaded(array($driver)))
			{
	...
	public static function isExtensionLoaded($drivers = array('imagick2', 'imagick', 'gd', 'magickwand'))
	{
		reset($drivers);
