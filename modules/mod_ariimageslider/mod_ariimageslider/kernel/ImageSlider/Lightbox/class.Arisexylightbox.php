...
class ArisexylightboxImageSliderEngine extends AriImageSliderLightboxEngine 
{
	function preCheck()
	{
		...
		$plgPath = JPATH_ROOT . '/plugins/system/arisexylightbox/arisexylightbox.php';
		if (!@file_exists($plgPath))
		{
			$app = JFactory::getApplication();

			$app->enqueueMessage('<b>ARI Image Slider</b>: "System - ARI Sexy Lightbox" plugin isn\'t installed.');
