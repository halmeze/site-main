...
class AriprettyphotoImageSliderEngine extends AriImageSliderLightboxEngine 
{
	function preCheck()
	{
		...
		$plgPath = JPATH_ROOT . '/plugins/system/ariprettyphoto/ariprettyphoto.php';
		if (!@file_exists($plgPath))
		{
			$app = JFactory::getApplication();

			$app->enqueueMessage('<b>ARI Image Slider</b>: "System - ARI Pretty Photo" plugin isn\'t installed.');
