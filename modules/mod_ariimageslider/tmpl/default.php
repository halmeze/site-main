...
?>
<div id="<?php echo $sliderId; ?>_wrapper" class="ari-image-slider-wrapper ari-image-slider-loading ari-is-theme-<?php echo $theme; ?><?php if ($cssClass):?> <?php echo $cssClass; ?><?php endif; ?><?php if ($controlNav):?> ari-image-slider-wCtrlNav<?php endif; ?>">
		...
		<div class="nivo-controlNavHolder">
			...
			<?php
				...
				foreach ($slides as $slide):
                    ...
                    $navElAttrs = array('class' => 'nivo-thumbNavWrapper');
			...
			?>
				<a rel="<?php echo $slideIdx; ?>" class="nivo-control<?php if ($startSlide == $slideIdx):?> active<?php endif; ?>">
					<span<?php echo AriHtmlHelper::getAttrStr($navElAttrs); ?>>
						<?php echo $navEl; ?>
