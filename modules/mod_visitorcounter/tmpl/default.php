...
<div class="visitorcounter <?php echo $moduleclass_sfx ?>">
	...
	<?php if($counterwinner AND $all_visitors >= $cwnumber AND $cwcode AND $cwemail) : ?>
		...
		<p class="center">
			<?php echo JText::_('MOD_VISITORCOUNTER_SENDIN'); ?>
			<strong><a href="mailto:<?php echo $cwemail; ?>?subject=<?php echo JText::_('MOD_VISITORCOUNTER_CONTEST'); ?>!%20Code:%20<?php echo $cwcode; ?>" title="<?php echo JText::_('MOD_VISITORCOUNTER_CONTEST'); ?>"><?php echo JText::_('MOD_VISITORCOUNTER_JOINNOW'); ?></a></strong>
		</p>
	<?php endif; ?>
