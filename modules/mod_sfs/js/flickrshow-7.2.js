...
flickrshow = function(target, settings) {
	...
	_.onClickPlay = function() {
		...
		if (_.constants.isPlaying === false) {
			...
			_.elements.buttons.childNodes[2].style.backgroundImage = 'url(' + _.settings.baseURL + '/modules/mod_sfs/images/play.png)';
			execute = function() {
			...
			_.elements.buttons.childNodes[2].style.backgroundImage = 'url(' + _.settings.baseURL + '/modules/mod_sfs/images/pause1.png)';
	...
	_.showFlickr = function() {
		...
		window.open('http://www.flickr.com/photos/' + img.getAttribute('data-flickr-owner') + '/' + img.getAttribute('data-flickr-photo_id') + '/');
	};
